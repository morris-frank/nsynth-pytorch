...
def test_blockwiseconv1d():
    ...
    conv.weight = nn.Parameter(torch.randint(100, (n_filters, n_channels, 1)), requires_grad=False)
    conv.bias = nn.Parameter(torch.randint(100, (n_filters,)), requires_grad=False)
